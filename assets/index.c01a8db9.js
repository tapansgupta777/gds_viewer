...
`)+`
`+A);const R=x+d+o,D=x+A+a,C=Fo(r,r.VERTEX_SHADER,R),w=Fo(r,r.FRAGMENT_SHADER,D);r.attachShader(u,C),r.attachShader(u,w),t.index0AttributeName!==void 0?r.bindAttribLocation(u,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(u,0,"position"),r.linkProgram(u);function V(X){if(i.debug.checkShaderErrors){const ne=r.getProgramInfoLog(u).trim(),P=r.getShaderInfoLog(C).trim(),H=r.getShaderInfoLog(w).trim();let z=!0,Y=!0;if(r.getProgramParameter(u,r.LINK_STATUS)===!1)if(z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,u,C,w);else{const W=Oo(r,C,"vertex"),k=Oo(r,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(u,r.VALIDATE_STATUS)+`
...
}`;function _m(i,e,t){let n=new aa;const r=new Ce,s=new Ce,o=new mt,a=new fm({depthPacking:Kc}),l=new pm,c={},h=t.maxTextureSize,f={[Pn]:Lt,[Lt]:Pn,[Jt]:Jt},p=new Un({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ce},radius:{value:4}},vertexShader:mm,fragmentShader:gm}),m=p.clone();m.defines.HORIZONTAL_PASS=1;const _=new rn;_.setAttribute("position",new Dt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const S=new Xt(_,p),u=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=cl;let d=this.type;this.render=function(C,w,V){if(u.enabled===!1||u.autoUpdate===!1&&u.needsUpdate===!1||C.length===0)return;const se=i.getRenderTarget(),v=i.getActiveCubeFace(),b=i.getActiveMipmapLevel(),X=i.state;X.setBlending(Rn),X.buffers.color.setClear(1,1,1,1),X.buffers.depth.setTest(!0),X.setScissorTest(!1);const ne=d!==un&&this.type===un,P=d===un&&this.type!==un;for(let H=0,z=C.length;H<z;H++){const Y=C[H],W=Y.shadow;if(W===void 0){console.warn("THREE.WebGLShadowMap:",Y,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;r.copy(W.mapSize);const k=W.getFrameExtents();if(r.multiply(k),s.copy(W.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/k.x),r.x=s.x*k.x,W.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/k.y),r.y=s.y*k.y,W.mapSize.y=s.y)),W.map===null||ne===!0||P===!0){const J=this.type!==un?{minFilter:Tt,magFilter:Tt}:{};W.map!==null&&W.map.dispose(),W.map=new Kn(r.x,r.y,J),W.map.texture.name=Y.name+".shadowMap",W.camera.updateProjectionMatrix()}i.setRenderTarget(W.map),i.clear();const K=W.getViewportCount();for(let J=0;J<K;J++){const fe=W.getViewport(J);o.set(s.x*fe.x,s.y*fe.y,s.x*fe.z,s.y*fe.w),X.viewport(o),W.updateMatrices(Y,J),n=W.getFrustum(),R(w,V,W.camera,Y,this.type)}W.isPointLightShadow!==!0&&this.type===un&&A(W,V),W.needsUpdate=!1}d=this.type,u.needsUpdate=!1,i.setRenderTarget(se,v,b)};function A(C,w){const V=e.update(S);p.defines.VSM_SAMPLES!==C.blurSamples&&(p.defines.VSM_SAMPLES=C.blurSamples,m.defines.VSM_SAMPLES=C.blurSamples,p.needsUpdate=!0,m.needsUpdate=!0),C.mapPass===null&&(C.mapPass=new Kn(r.x,r.y)),p.uniforms.shadow_pass.value=C.map.texture,p.uniforms.resolution.value=C.mapSize,p.uniforms.radius.value=C.radius,i.setRenderTarget(C.mapPass),i.clear(),i.renderBufferDirect(w,null,V,p,S,null),m.uniforms.shadow_pass.value=C.mapPass.texture,m.uniforms.resolution.value=C.mapSize,m.uniforms.radius.value=C.radius,i.setRenderTarget(C.map),i.clear(),i.renderBufferDirect(w,null,V,m,S,null)}function x(C,w,V,se){let v=null;const b=V.isPointLight===!0?C.customDistanceMaterial:C.customDepthMaterial;if(b!==void 0)v=b;else if(v=V.isPointLight===!0?l:a,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const X=v.uuid,ne=w.uuid;let P=c[X];P===void 0&&(P={},c[X]=P);let H=P[ne];H===void 0&&(H=v.clone(),P[ne]=H,w.addEventListener("dispose",D)),v=H}if(v.visible=w.visible,v.wireframe=w.wireframe,se===un?v.side=w.shadowSide!==null?w.shadowSide:w.side:v.side=w.shadowSide!==null?w.shadowSide:f[w.side],v.alphaMap=w.alphaMap,v.alphaTest=w.alphaTest,v.map=w.map,v.clipShadows=w.clipShadows,v.clippingPlanes=w.clippingPlanes,v.clipIntersection=w.clipIntersection,v.displacementMap=w.displacementMap,v.displacementScale=w.displacementScale,v.displacementBias=w.displacementBias,v.wireframeLinewidth=w.wireframeLinewidth,v.linewidth=w.linewidth,V.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const X=i.properties.get(v);X.light=V}return v}function R(C,w,V,se,v){if(C.visible===!1)return;if(C.layers.test(w.layers)&&(C.isMesh||C.isLine||C.isPoints)&&(C.castShadow||C.receiveShadow&&v===un)&&(!C.frustumCulled||n.intersectsObject(C))){C.modelViewMatrix.multiplyMatrices(V.matrixWorldInverse,C.matrixWorld);const ne=e.update(C),P=C.material;if(Array.isArray(P)){const H=ne.groups;for(let z=0,Y=H.length;z<Y;z++){const W=H[z],k=P[W.materialIndex];if(k&&k.visible){const K=x(C,k,se,v);C.onBeforeShadow(i,C,w,V,ne,K,W),i.renderBufferDirect(V,null,ne,K,C,W),C.onAfterShadow(i,C,w,V,ne,K,W)}}}else if(P.visible){const H=x(C,P,se,v);C.onBeforeShadow(i,C,w,V,ne,H,null),i.renderBufferDirect(V,null,ne,H,C,null),C.onAfterShadow(i,C,w,V,ne,H,null)}}const X=C.children;for(let ne=0,P=X.length;ne<P;ne++)R(X[ne],w,V,se,v)}function D(C){C.target.removeEventListener("dispose",D);for(const V in c){const se=c[V],v=C.target.uuid;v in se&&(se[v].dispose(),delete se[v])}}}function vm(i,e,t){const n=t.isWebGL2;function r(){let E=!1;const ee=new mt;let j=null;const ge=new mt(0,0,0,0);return{setMask:function(ye){j!==ye&&!E&&(i.colorMask(ye,ye,ye,ye),j=ye)},setLocked:function(ye){E=ye},setClear:function(ye,qe,We,Je,gt){gt===!0&&(ye*=Je,qe*=Je,We*=Je),ee.set(ye,qe,We,Je),ge.equals(ee)===!1&&(i.clearColor(ye,qe,We,Je),ge.copy(ee))},reset:function(){E=!1,j=null,ge.set(-1,0,0,0)}}}function s(){let E=!1,ee=null,j=null,ge=null;return{setTest:function(ye){ye?pe(i.DEPTH_TEST):Xe(i.DEPTH_TEST)},setMask:function(ye){ee!==ye&&!E&&(i.depthMask(ye),ee=ye)},setFunc:function(ye){if(j!==ye){switch(ye){case Tc:i.depthFunc(i.NEVER);break;case wc:i.depthFunc(i.ALWAYS);break;case Rc:i.depthFunc(i.LESS);break;case Gr:i.depthFunc(i.LEQUAL);break;case Cc:i.depthFunc(i.EQUAL);break;case Lc:i.depthFunc(i.GEQUAL);break;case Pc:i.depthFunc(i.GREATER);break;case Dc:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}j=ye}},setLocked:function(ye){E=ye},setClear:function(ye){ge!==ye&&(i.clearDepth(ye),ge=ye)},reset:function(){E=!1,ee=null,j=null,ge=null}}}function o(){let E=!1,ee=null,j=null,ge=null,ye=null,qe=null,We=null,Je=null,gt=null;return{setTest:function(je){E||(je?pe(i.STENCIL_TEST):Xe(i.STENCIL_TEST))},setMask:function(je){ee!==je&&!E&&(i.stencilMask(je),ee=je)},setFunc:function(je,ot,Et){(j!==je||ge!==ot||ye!==Et)&&(i.stencilFunc(je,ot,Et),j=je,ge=ot,ye=Et)},setOp:function(je,ot,Et){(qe!==je||We!==ot||Je!==Et)&&(i.stencilOp(je,ot,Et),qe=je,We=ot,Je=Et)},setLocked:function(je){E=je},setClear:function(je){gt!==je&&(i.clearStencil(je),gt=je)},reset:function(){E=!1,ee=null,j=null,ge=null,ye=null,qe=null,We=null,Je=null,gt=null}}}const a=new r,l=new s,c=new o,h=new WeakMap,f=new WeakMap;let p={},m={},_=new WeakMap,S=[],u=null,d=!1,A=null,x=null,R=null,D=null,C=null,w=null,V=null,se=new Ue(0,0,0),v=0,b=!1,X=null,ne=null,P=null,H=null,z=null;const Y=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let W=!1,k=0;const K=i.getParameter(i.VERSION);K.indexOf("WebGL")!==-1?(k=parseFloat(/^WebGL (\d)/.exec(K)[1]),W=k>=1):K.indexOf("OpenGL ES")!==-1&&(k=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),W=k>=2);let J=null,fe={};const we=i.getParameter(i.SCISSOR_BOX),G=i.getParameter(i.VIEWPORT),Z=new mt().fromArray(we),ue=new mt().fromArray(G);function Ee(E,ee,j,ge){const ye=new Uint8Array(4),qe=i.createTexture();i.bindTexture(E,qe),i.texParameteri(E,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(E,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let We=0;We<j;We++)n&&(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)?i.texImage3D(ee,0,i.RGBA,1,1,ge,0,i.RGBA,i.UNSIGNED_BYTE,ye):i.texImage2D(ee+We,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ye);return qe}const Ae={};Ae[i.TEXTURE_2D]=Ee(i.TEXTURE_2D,i.TEXTURE_2D,1),Ae[i.TEXTURE_CUBE_MAP]=Ee(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),n&&(Ae[i.TEXTURE_2D_ARRAY]=Ee(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Ae[i.TEXTURE_3D]=Ee(i.TEXTURE_3D,i.TEXTURE_3D,1,1)),a.setClear(0,0,0,1),l.setClear(1),c.setClear(0),pe(i.DEPTH_TEST),l.setFunc(Gr),Ie(!1),y(ya),pe(i.CULL_FACE),_e(Rn);function pe(E){p[E]!==!0&&(i.enable(E),p[E]=!0)}function Xe(E){p[E]!==!1&&(i.disable(E),p[E]=!1)}function De(E,ee){return m[E]!==ee?(i.bindFramebuffer(E,ee),m[E]=ee,n&&(E===i.DRAW_FRAMEBUFFER&&(m[i.FRAMEBUFFER]=ee),E===i.FRAMEBUFFER&&(m[i.DRAW_FRAMEBUFFER]=ee)),!0):!1}function I(E,ee){let j=S,ge=!1;if(E)if(j=_.get(ee),j===void 0&&(j=[],_.set(ee,j)),E.isWebGLMultipleRenderTargets){const ye=E.texture;if(j.length!==ye.length||j[0]!==i.COLOR_ATTACHMENT0){for(let qe=0,We=ye.length;qe<We;qe++)j[qe]=i.COLOR_ATTACHMENT0+qe;j.length=ye.length,ge=!0}}else j[0]!==i.COLOR_ATTACHMENT0&&(j[0]=i.COLOR_ATTACHMENT0,ge=!0);else j[0]!==i.BACK&&(j[0]=i.BACK,ge=!0);ge&&(t.isWebGL2?i.drawBuffers(j):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(j))}function ht(E){return u!==E?(i.useProgram(E),u=E,!0):!1}const Se={[kn]:i.FUNC_ADD,[uc]:i.FUNC_SUBTRACT,[dc]:i.FUNC_REVERSE_SUBTRACT};if(n)Se[Ta]=i.MIN,Se[wa]=i.MAX;else{const E=e.get("EXT_blend_minmax");E!==null&&(Se[Ta]=E.MIN_EXT,Se[wa]=E.MAX_EXT)}const Re={[fc]:i.ZERO,[pc]:i.ONE,[mc]:i.SRC_COLOR,[Hs]:i.SRC_ALPHA,[Sc]:i.SRC_ALPHA_SATURATE,[xc]:i.DST_COLOR,[_c]:i.DST_ALPHA,[gc]:i.ONE_MINUS_SRC_COLOR,[Gs]:i.ONE_MINUS_SRC_ALPHA,[Mc]:i.ONE_MINUS_DST_COLOR,[vc]:i.ONE_MINUS_DST_ALPHA,[yc]:i.CONSTANT_COLOR,[Ec]:i.ONE_MINUS_CONSTANT_COLOR,[bc]:i.CONSTANT_ALPHA,[Ac]:i.ONE_MINUS_CONSTANT_ALPHA};function _e(E,ee,j,ge,ye,qe,We,Je,gt,je){if(E===Rn){d===!0&&(Xe(i.BLEND),d=!1);return}if(d===!1&&(pe(i.BLEND),d=!0),E!==hc){if(E!==A||je!==b){if((x!==kn||C!==kn)&&(i.blendEquation(i.FUNC_ADD),x=kn,C=kn),je)switch(E){case Ei:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ea:i.blendFunc(i.ONE,i.ONE);break;case ba:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Aa:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",E);break}else switch(E){case Ei:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ea:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case ba:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Aa:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",E);break}R=null,D=null,w=null,V=null,se.set(0,0,0),v=0,A=E,b=je}return}ye=ye||ee,qe=qe||j,We=We||ge,(ee!==x||ye!==C)&&(i.blendEquationSeparate(Se[ee],Se[ye]),x=ee,C=ye),(j!==R||ge!==D||qe!==w||We!==V)&&(i.blendFuncSeparate(Re[j],Re[ge],Re[qe],Re[We]),R=j,D=ge,w=qe,V=We),(Je.equals(se)===!1||gt!==v)&&(i.blendColor(Je.r,Je.g,Je.b,gt),se.copy(Je),v=gt),A=E,b=!1}function et(E,ee){E.side===Jt?Xe(i.CULL_FACE):pe(i.CULL_FACE);let j=E.side===Lt;ee&&(j=!j),Ie(j),E.blending===Ei&&E.transparent===!1?_e(Rn):_e(E.blending,E.blendEquation,E.blendSrc,E.blendDst,E.blendEquationAlpha,E.blendSrcAlpha,E.blendDstAlpha,E.blendColor,E.blendAlpha,E.premultipliedAlpha),l.setFunc(E.depthFunc),l.setTest(E.depthTest),l.setMask(E.depthWrite),a.setMask(E.colorWrite);const ge=E.stencilWrite;c.setTest(ge),ge&&(c.setMask(E.stencilWriteMask),c.setFunc(E.stencilFunc,E.stencilRef,E.stencilFuncMask),c.setOp(E.stencilFail,E.stencilZFail,E.stencilZPass)),N(E.polygonOffset,E.polygonOffsetFactor,E.polygonOffsetUnits),E.alphaToCoverage===!0?pe(i.SAMPLE_ALPHA_TO_COVERAGE):Xe(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ie(E){X!==E&&(E?i.frontFace(i.CW):i.frontFace(i.CCW),X=E)}function y(E){E!==oc?(pe(i.CULL_FACE),E!==ne&&(E===ya?i.cullFace(i.BACK):E===lc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Xe(i.CULL_FACE),ne=E}function g(E){E!==P&&(W&&i.lineWidth(E),P=E)}function N(E,ee,j){E?(pe(i.POLYGON_OFFSET_FILL),(H!==ee||z!==j)&&(i.polygonOffset(ee,j),H=ee,z=j)):Xe(i.POLYGON_OFFSET_FILL)}function te(E){E?pe(i.SCISSOR_TEST):Xe(i.SCISSOR_TEST)}function $(E){E===void 0&&(E=i.TEXTURE0+Y-1),J!==E&&(i.activeTexture(E),J=E)}function Q(E,ee,j){j===void 0&&(J===null?j=i.TEXTURE0+Y-1:j=J);let ge=fe[j];ge===void 0&&(ge={type:void 0,texture:void 0},fe[j]=ge),(ge.type!==E||ge.texture!==ee)&&(J!==j&&(i.activeTexture(j),J=j),i.bindTexture(E,ee||Ae[E]),ge.type=E,ge.texture=ee)}function me(){const E=fe[J];E!==void 0&&E.type!==void 0&&(i.bindTexture(E.type,null),E.type=void 0,E.texture=void 0)}function oe(){try{i.compressedTexImage2D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function de(){try{i.compressedTexImage3D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function be(){try{i.texSubImage2D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function Ne(){try{i.texSubImage3D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function q(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function Ke(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function He(){try{i.texStorage2D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function Le(){try{i.texStorage3D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function xe(){try{i.texImage2D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function ce(){try{i.texImage3D.apply(i,arguments)}catch(E){console.error("THREE.WebGLState:",E)}}function Oe(E){Z.equals(E)===!1&&(i.scissor(E.x,E.y,E.z,E.w),Z.copy(E))}function T(E){ue.equals(E)===!1&&(i.viewport(E.x,E.y,E.z,E.w),ue.copy(E))}function ie(E,ee){let j=f.get(ee);j===void 0&&(j=new WeakMap,f.set(ee,j));let ge=j.get(E);ge===void 0&&(ge=i.getUniformBlockIndex(ee,E.name),j.set(E,ge))}function le(E,ee){const ge=f.get(ee).get(E);h.get(ee)!==ge&&(i.uniformBlockBinding(ee,ge,E.__bindingPointIndex),h.set(ee,ge))}function Me(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),n===!0&&(i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null)),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),p={},J=null,fe={},m={},_=new WeakMap,S=[],u=null,d=!1,A=null,x=null,R=null,D=null,C=null,w=null,V=null,se=new Ue(0,0,0),v=0,b=!1,X=null,ne=null,P=null,H=null,z=null,Z.set(0,0,i.canvas.width,i.canvas.height),ue.set(0,0,i.canvas.width,i.canvas.height),a.reset(),l.reset(),c.reset()}return{buffers:{color:a,depth:l,stencil:c},enable:pe,disable:Xe,bindFramebuffer:De,drawBuffers:I,useProgram:ht,setBlending:_e,setMaterial:et,setFlipSided:Ie,setCullFace:y,setLineWidth:g,setPolygonOffset:N,setScissorTest:te,activeTexture:$,bindTexture:Q,unbindTexture:me,compressedTexImage2D:oe,compressedTexImage3D:de,texImage2D:xe,texImage3D:ce,updateUBOMapping:ie,uniformBlockBinding:le,texStorage2D:He,texStorage3D:Le,texSubImage2D:be,texSubImage3D:Ne,compressedTexSubImage2D:q,compressedTexSubImage3D:Ke,scissor:Oe,viewport:T,reset:Me}}function xm(i,e,t,n,r,s,o){const a=r.isWebGL2,l=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new WeakMap;let f;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(y,g){return m?new OffscreenCanvas(y,g):$r("canvas")}function S(y,g,N,te){let $=1;if((y.width>te||y.height>te)&&($=te/Math.max(y.width,y.height)),$<1||g===!0)if(typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&y instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&y instanceof ImageBitmap){const Q=g?Yr:Math.floor,me=Q($*y.width),oe=Q($*y.height);f===void 0&&(f=_(me,oe));const de=N?_(me,oe):f;return de.width=me,de.height=oe,de.getContext("2d").drawImage(y,0,0,me,oe),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+y.width+"x"+y.height+") to ("+me+"x"+oe+")."),de}else return"data"in y&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+y.width+"x"+y.height+")."),y;return y}function u(y){return $s(y.width)&&$s(y.height)}function d(y){return a?!1:y.wrapS!==jt||y.wrapT!==jt||y.minFilter!==Tt&&y.minFilter!==Rt}function A(y,g){return y.generateMipmaps&&g&&y.minFilter!==Tt&&y.minFilter!==Rt}function x(y){i.generateMipmap(y)}function R(y,g,N,te,$=!1){if(a===!1)return g;if(y!==null){if(i[y]!==void 0)return i[y];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+y+"'")}let Q=g;if(g===i.RED&&(N===i.FLOAT&&(Q=i.R32F),N===i.HALF_FLOAT&&(Q=i.R16F),N===i.UNSIGNED_BYTE&&(Q=i.R8)),g===i.RED_INTEGER&&(N===i.UNSIGNED_BYTE&&(Q=i.R8UI),N===i.UNSIGNED_SHORT&&(Q=i.R16UI),N===i.UNSIGNED_INT&&(Q=i.R32UI),N===i.BYTE&&(Q=i.R8I),N===i.SHORT&&(Q=i.R16I),N===i.INT&&(Q=i.R32I)),g===i.RG&&(N===i.FLOAT&&(Q=i.RG32F),N===i.HALF_FLOAT&&(Q=i.RG16F),N===i.UNSIGNED_BYTE&&(Q=i.RG8)),g===i.RGBA){const me=$?kr:Ze.getTransfer(te);N===i.FLOAT&&(Q=i.RGBA32F),N===i.HALF_FLOAT&&(Q=i.RGBA16F),N===i.UNSIGNED_BYTE&&(Q=me===tt?i.SRGB8_ALPHA8:i.RGBA8),N===i.UNSIGNED_SHORT_4_4_4_4&&(Q=i.RGBA4),N===i.UNSIGNED_SHORT_5_5_5_1&&(Q=i.RGB5_A1)}return(Q===i.R16F||Q===i.R32F||Q===i.RG16F||Q===i.RG32F||Q===i.RGBA16F||Q===i.RGBA32F)&&e.get("EXT_color_buffer_float"),Q}function D(y,g,N){return A(y,N)===!0||y.isFramebufferTexture&&y.minFilter!==Tt&&y.minFilter!==Rt?Math.log2(Math.max(g.width,g.height))+1:y.mipmaps!==void 0&&y.mipmaps.length>0?y.mipmaps.length:y.isCompressedTexture&&Array.isArray(y.image)?g.mipmaps.length:1}function C(y){return y===Tt||y===Ra||y===Oi?i.NEAREST:i.LINEAR}function w(y){const g=y.target;g.removeEventListener("dispose",w),se(g),g.isVideoTexture&&h.delete(g)}function V(y){const g=y.target;g.removeEventListener("dispose",V),b(g)}function se(y){const g=n.get(y);if(g.__webglInit===void 0)return;const N=y.source,te=p.get(N);if(te){const $=te[g.__cacheKey];$.usedTimes--,$.usedTimes===0&&v(y),Object.keys(te).length===0&&p.delete(N)}n.remove(y)}function v(y){const g=n.get(y);i.deleteTexture(g.__webglTexture);const N=y.source,te=p.get(N);delete te[g.__cacheKey],o.memory.textures--}function b(y){const g=y.texture,N=n.get(y),te=n.get(g);if(te.__webglTexture!==void 0&&(i.deleteTexture(te.__webglTexture),o.memory.textures--),y.depthTexture&&y.depthTexture.dispose(),y.isWebGLCubeRenderTarget)for(let $=0;$<6;$++){if(Array.isArray(N.__webglFramebuffer[$]))for(let Q=0;Q<N.__webglFramebuffer[$].length;Q++)i.deleteFramebuffer(N.__webglFramebuffer[$][Q]);else i.deleteFramebuffer(N.__webglFramebuffer[$]);N.__webglDepthbuffer&&i.deleteRenderbuffer(N.__webglDepthbuffer[$])}else{if(Array.isArray(N.__webglFramebuffer))for(let $=0;$<N.__webglFramebuffer.length;$++)i.deleteFramebuffer(N.__webglFramebuffer[$]);else i.deleteFramebuffer(N.__webglFramebuffer);if(N.__webglDepthbuffer&&i.deleteRenderbuffer(N.__webglDepthbuffer),N.__webglMultisampledFramebuffer&&i.deleteFramebuffer(N.__webglMultisampledFramebuffer),N.__webglColorRenderbuffer)for(let $=0;$<N.__webglColorRenderbuffer.length;$++)N.__webglColorRenderbuffer[$]&&i.deleteRenderbuffer(N.__webglColorRenderbuffer[$]);N.__webglDepthRenderbuffer&&i.deleteRenderbuffer(N.__webglDepthRenderbuffer)}if(y.isWebGLMultipleRenderTargets)for(let $=0,Q=g.length;$<Q;$++){const me=n.get(g[$]);me.__webglTexture&&(i.deleteTexture(me.__webglTexture),o.memory.textures--),n.remove(g[$])}n.remove(g),n.remove(y)}let X=0;function ne(){X=0}function P(){const y=X;return y>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+y+" texture units while this GPU supports only "+r.maxTextures),X+=1,y}function H(y){const g=[];return g.push(y.wrapS),g.push(y.wrapT),g.push(y.wrapR||0),g.push(y.magFilter),g.push(y.minFilter),g.push(y.anisotropy),g.push(y.internalFormat),g.push(y.format),g.push(y.type),g.push(y.generateMipmaps),g.push(y.premultiplyAlpha),g.push(y.flipY),g.push(y.unpackAlignment),g.push(y.colorSpace),g.join()}function z(y,g){const N=n.get(y);if(y.isVideoTexture&&et(y),y.isRenderTargetTexture===!1&&y.version>0&&N.__version!==y.version){const te=y.image;if(te===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(te.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Z(N,y,g);return}}t.bindTexture(i.TEXTURE_2D,N.__webglTexture,i.TEXTURE0+g)}function Y(y,g){const N=n.get(y);if(y.version>0&&N.__version!==y.version){Z(N,y,g);return}t.bindTexture(i.TEXTURE_2D_ARRAY,N.__webglTexture,i.TEXTURE0+g)}function W(y,g){const N=n.get(y);if(y.version>0&&N.__version!==y.version){Z(N,y,g);return}t.bindTexture(i.TEXTURE_3D,N.__webglTexture,i.TEXTURE0+g)}function k(y,g){const N=n.get(y);if(y.version>0&&N.__version!==y.version){ue(N,y,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,N.__webglTexture,i.TEXTURE0+g)}const K={[Ws]:i.REPEAT,[jt]:i.CLAMP_TO_EDGE,[Xs]:i.MIRRORED_REPEAT},J={[Tt]:i.NEAREST,[Ra]:i.NEAREST_MIPMAP_NEAREST,[Oi]:i.NEAREST_MIPMAP_LINEAR,[Rt]:i.LINEAR,[os]:i.LINEAR_MIPMAP_NEAREST,[Xn]:i.LINEAR_MIPMAP_LINEAR},fe={[Jc]:i.NEVER,[rh]:i.ALWAYS,[Qc]:i.LESS,[Sl]:i.LEQUAL,[eh]:i.EQUAL,[ih]:i.GEQUAL,[th]:i.GREATER,[nh]:i.NOTEQUAL};function we(y,g,N){if(g.type===fn&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===Rt||g.magFilter===os||g.magFilter===Oi||g.magFilter===Xn||g.minFilter===Rt||g.minFilter===os||g.minFilter===Oi||g.minFilter===Xn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),N?(i.texParameteri(y,i.TEXTURE_WRAP_S,K[g.wrapS]),i.texParameteri(y,i.TEXTURE_WRAP_T,K[g.wrapT]),(y===i.TEXTURE_3D||y===i.TEXTURE_2D_ARRAY)&&i.texParameteri(y,i.TEXTURE_WRAP_R,K[g.wrapR]),i.texParameteri(y,i.TEXTURE_MAG_FILTER,J[g.magFilter]),i.texParameteri(y,i.TEXTURE_MIN_FILTER,J[g.minFilter])):(i.texParameteri(y,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(y,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE),(y===i.TEXTURE_3D||y===i.TEXTURE_2D_ARRAY)&&i.texParameteri(y,i.TEXTURE_WRAP_R,i.CLAMP_TO_EDGE),(g.wrapS!==jt||g.wrapT!==jt)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),i.texParameteri(y,i.TEXTURE_MAG_FILTER,C(g.magFilter)),i.texParameteri(y,i.TEXTURE_MIN_FILTER,C(g.minFilter)),g.minFilter!==Tt&&g.minFilter!==Rt&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),g.compareFunction&&(i.texParameteri(y,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(y,i.TEXTURE_COMPARE_FUNC,fe[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const te=e.get("EXT_texture_filter_anisotropic");if(g.magFilter===Tt||g.minFilter!==Oi&&g.minFilter!==Xn||g.type===fn&&e.has("OES_texture_float_linear")===!1||a===!1&&g.type===Ji&&e.has("OES_texture_half_float_linear")===!1)return;(g.anisotropy>1||n.get(g).__currentAnisotropy)&&(i.texParameterf(y,te.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,r.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy)}}function G(y,g){let N=!1;y.__webglInit===void 0&&(y.__webglInit=!0,g.addEventListener("dispose",w));const te=g.source;let $=p.get(te);$===void 0&&($={},p.set(te,$));const Q=H(g);if(Q!==y.__cacheKey){$[Q]===void 0&&($[Q]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,N=!0),$[Q].usedTimes++;const me=$[y.__cacheKey];me!==void 0&&($[y.__cacheKey].usedTimes--,me.usedTimes===0&&v(g)),y.__cacheKey=Q,y.__webglTexture=$[Q].texture}return N}function Z(y,g,N){let te=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(te=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(te=i.TEXTURE_3D);const $=G(y,g),Q=g.source;t.bindTexture(te,y.__webglTexture,i.TEXTURE0+N);const me=n.get(Q);if(Q.version!==me.__version||$===!0){t.activeTexture(i.TEXTURE0+N);const oe=Ze.getPrimaries(Ze.workingColorSpace),de=g.colorSpace===Wt?null:Ze.getPrimaries(g.colorSpace),be=g.colorSpace===Wt||oe===de?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,be);const Ne=d(g)&&u(g.image)===!1;let q=S(g.image,Ne,!1,r.maxTextureSize);q=Ie(g,q);const Ke=u(q)||a,He=s.convert(g.format,g.colorSpace);let Le=s.convert(g.type),xe=R(g.internalFormat,He,Le,g.colorSpace,g.isVideoTexture);we(te,g,Ke);let ce;const Oe=g.mipmaps,T=a&&g.isVideoTexture!==!0&&xe!==vl,ie=me.__version===void 0||$===!0,le=Q.dataReady,Me=D(g,q,Ke);if(g.isDepthTexture)xe=i.DEPTH_COMPONENT,a?g.type===fn?xe=i.DEPTH_COMPONENT32F:g.type===wn?xe=i.DEPTH_COMPONENT24:g.type===Yn?xe=i.DEPTH24_STENCIL8:xe=i.DEPTH_COMPONENT16:g.type===fn&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),g.format===$n&&xe===i.DEPTH_COMPONENT&&g.type!==na&&g.type!==wn&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),g.type=wn,Le=s.convert(g.type)),g.format===Ri&&xe===i.DEPTH_COMPONENT&&(xe=i.DEPTH_STENCIL,g.type!==Yn&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),g.type=Yn,Le=s.convert(g.type))),ie&&(T?t.texStorage2D(i.TEXTURE_2D,1,xe,q.width,q.height):t.texImage2D(i.TEXTURE_2D,0,xe,q.width,q.height,0,He,Le,null));else if(g.isDataTexture)if(Oe.length>0&&Ke){T&&ie&&t.texStorage2D(i.TEXTURE_2D,Me,xe,Oe[0].width,Oe[0].height);for(let E=0,ee=Oe.length;E<ee;E++)ce=Oe[E],T?le&&t.texSubImage2D(i.TEXTURE_2D,E,0,0,ce.width,ce.height,He,Le,ce.data):t.texImage2D(i.TEXTURE_2D,E,xe,ce.width,ce.height,0,He,Le,ce.data);g.generateMipmaps=!1}else T?(ie&&t.texStorage2D(i.TEXTURE_2D,Me,xe,q.width,q.height),le&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,q.width,q.height,He,Le,q.data)):t.texImage2D(i.TEXTURE_2D,0,xe,q.width,q.height,0,He,Le,q.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){T&&ie&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Me,xe,Oe[0].width,Oe[0].height,q.depth);for(let E=0,ee=Oe.length;E<ee;E++)ce=Oe[E],g.format!==Kt?He!==null?T?le&&t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,E,0,0,0,ce.width,ce.height,q.depth,He,ce.data,0,0):t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,E,xe,ce.width,ce.height,q.depth,0,ce.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):T?le&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,E,0,0,0,ce.width,ce.height,q.depth,He,Le,ce.data):t.texImage3D(i.TEXTURE_2D_ARRAY,E,xe,ce.width,ce.height,q.depth,0,He,Le,ce.data)}else{T&&ie&&t.texStorage2D(i.TEXTURE_2D,Me,xe,Oe[0].width,Oe[0].height);for(let E=0,ee=Oe.length;E<ee;E++)ce=Oe[E],g.format!==Kt?He!==null?T?le&&t.compressedTexSubImage2D(i.TEXTURE_2D,E,0,0,ce.width,ce.height,He,ce.data):t.compressedTexImage2D(i.TEXTURE_2D,E,xe,ce.width,ce.height,0,ce.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):T?le&&t.texSubImage2D(i.TEXTURE_2D,E,0,0,ce.width,ce.height,He,Le,ce.data):t.texImage2D(i.TEXTURE_2D,E,xe,ce.width,ce.height,0,He,Le,ce.data)}else if(g.isDataArrayTexture)T?(ie&&t.texStorage3D(i.TEXTURE_2D_ARRAY,Me,xe,q.width,q.height,q.depth),le&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,q.width,q.height,q.depth,He,Le,q.data)):t.texImage3D(i.TEXTURE_2D_ARRAY,0,xe,q.width,q.height,q.depth,0,He,Le,q.data);else if(g.isData3DTexture)T?(ie&&t.texStorage3D(i.TEXTURE_3D,Me,xe,q.width,q.height,q.depth),le&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,q.width,q.height,q.depth,He,Le,q.data)):t.texImage3D(i.TEXTURE_3D,0,xe,q.width,q.height,q.depth,0,He,Le,q.data);else if(g.isFramebufferTexture){if(ie)if(T)t.texStorage2D(i.TEXTURE_2D,Me,xe,q.width,q.height);else{let E=q.width,ee=q.height;for(let j=0;j<Me;j++)t.texImage2D(i.TEXTURE_2D,j,xe,E,ee,0,He,Le,null),E>>=1,ee>>=1}}else if(Oe.length>0&&Ke){T&&ie&&t.texStorage2D(i.TEXTURE_2D,Me,xe,Oe[0].width,Oe[0].height);for(let E=0,ee=Oe.length;E<ee;E++)ce=Oe[E],T?le&&t.texSubImage2D(i.TEXTURE_2D,E,0,0,He,Le,ce):t.texImage2D(i.TEXTURE_2D,E,xe,He,Le,ce);g.generateMipmaps=!1}else T?(ie&&t.texStorage2D(i.TEXTURE_2D,Me,xe,q.width,q.height),le&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,He,Le,q)):t.texImage2D(i.TEXTURE_2D,0,xe,He,Le,q);A(g,Ke)&&x(te),me.__version=Q.version,g.onUpdate&&g.onUpdate(g)}y.__version=g.version}function ue(y,g,N){if(g.image.length!==6)return;const te=G(y,g),$=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,y.__webglTexture,i.TEXTURE0+N);const Q=n.get($);if($.version!==Q.__version||te===!0){t.activeTexture(i.TEXTURE0+N);const me=Ze.getPrimaries(Ze.workingColorSpace),oe=g.colorSpace===Wt?null:Ze.getPrimaries(g.colorSpace),de=g.colorSpace===Wt||me===oe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,de);const be=g.isCompressedTexture||g.image[0].isCompressedTexture,Ne=g.image[0]&&g.image[0].isDataTexture,q=[];for(let E=0;E<6;E++)!be&&!Ne?q[E]=S(g.image[E],!1,!0,r.maxCubemapSize):q[E]=Ne?g.image[E].image:g.image[E],q[E]=Ie(g,q[E]);const Ke=q[0],He=u(Ke)||a,Le=s.convert(g.format,g.colorSpace),xe=s.convert(g.type),ce=R(g.internalFormat,Le,xe,g.colorSpace),Oe=a&&g.isVideoTexture!==!0,T=Q.__version===void 0||te===!0,ie=$.dataReady;let le=D(g,Ke,He);we(i.TEXTURE_CUBE_MAP,g,He);let Me;if(be){Oe&&T&&t.texStorage2D(i.TEXTURE_CUBE_MAP,le,ce,Ke.width,Ke.height);for(let E=0;E<6;E++){Me=q[E].mipmaps;for(let ee=0;ee<Me.length;ee++){const j=Me[ee];g.format!==Kt?Le!==null?Oe?ie&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,ee,0,0,j.width,j.height,Le,j.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,ee,ce,j.width,j.height,0,j.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Oe?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,ee,0,0,j.width,j.height,Le,xe,j.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,ee,ce,j.width,j.height,0,Le,xe,j.data)}}}else{Me=g.mipmaps,Oe&&T&&(Me.length>0&&le++,t.texStorage2D(i.TEXTURE_CUBE_MAP,le,ce,q[0].width,q[0].height));for(let E=0;E<6;E++)if(Ne){Oe?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,0,0,0,q[E].width,q[E].height,Le,xe,q[E].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,0,ce,q[E].width,q[E].height,0,Le,xe,q[E].data);for(let ee=0;ee<Me.length;ee++){const ge=Me[ee].image[E].image;Oe?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,ee+1,0,0,ge.width,ge.height,Le,xe,ge.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,ee+1,ce,ge.width,ge.height,0,Le,xe,ge.data)}}else{Oe?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,0,0,0,Le,xe,q[E]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,0,ce,Le,xe,q[E]);for(let ee=0;ee<Me.length;ee++){const j=Me[ee];Oe?ie&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,ee+1,0,0,Le,xe,j.image[E]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+E,ee+1,ce,Le,xe,j.image[E])}}}A(g,He)&&x(i.TEXTURE_CUBE_MAP),Q.__version=$.version,g.onUpdate&&g.onUpdate(g)}y.__version=g.version}function Ee(y,g,N,te,$,Q){const me=s.convert(N.format,N.colorSpace),oe=s.convert(N.type),de=R(N.internalFormat,me,oe,N.colorSpace);if(!n.get(g).__hasExternalTextures){const Ne=Math.max(1,g.width>>Q),q=Math.max(1,g.height>>Q);$===i.TEXTURE_3D||$===i.TEXTURE_2D_ARRAY?t.texImage3D($,Q,de,Ne,q,g.depth,0,me,oe,null):t.texImage2D($,Q,de,Ne,q,0,me,oe,null)}t.bindFramebuffer(i.FRAMEBUFFER,y),_e(g)?l.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,te,$,n.get(N).__webglTexture,0,Re(g)):($===i.TEXTURE_2D||$>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,te,$,n.get(N).__webglTexture,Q),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ae(y,g,N){if(i.bindRenderbuffer(i.RENDERBUFFER,y),g.depthBuffer&&!g.stencilBuffer){let te=a===!0?i.DEPTH_COMPONENT24:i.DEPTH_COMPONENT16;if(N||_e(g)){const $=g.depthTexture;$&&$.isDepthTexture&&($.type===fn?te=i.DEPTH_COMPONENT32F:$.type===wn&&(te=i.DEPTH_COMPONENT24));const Q=Re(g);_e(g)?l.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Q,te,g.width,g.height):i.renderbufferStorageMultisample(i.RENDERBUFFER,Q,te,g.width,g.height)}else i.renderbufferStorage(i.RENDERBUFFER,te,g.width,g.height);i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.RENDERBUFFER,y)}else if(g.depthBuffer&&g.stencilBuffer){const te=Re(g);N&&_e(g)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,te,i.DEPTH24_STENCIL8,g.width,g.height):_e(g)?l.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,te,i.DEPTH24_STENCIL8,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,i.DEPTH_STENCIL,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.RENDERBUFFER,y)}else{const te=g.isWebGLMultipleRenderTargets===!0?g.texture:[g.texture];for(let $=0;$<te.length;$++){const Q=te[$],me=s.convert(Q.format,Q.colorSpace),oe=s.convert(Q.type),de=R(Q.internalFormat,me,oe,Q.colorSpace),be=Re(g);N&&_e(g)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,be,de,g.width,g.height):_e(g)?l.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,be,de,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,de,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function pe(y,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,y),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(g.depthTexture).__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),z(g.depthTexture,0);const te=n.get(g.depthTexture).__webglTexture,$=Re(g);if(g.depthTexture.format===$n)_e(g)?l.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,te,0,$):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,te,0);else if(g.depthTexture.format===Ri)_e(g)?l.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,te,0,$):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,te,0);else throw new Error("Unknown depthTexture format")}function Xe(y){const g=n.get(y),N=y.isWebGLCubeRenderTarget===!0;if(y.depthTexture&&!g.__autoAllocateDepthBuffer){if(N)throw new Error("target.depthTexture not supported in Cube render targets");pe(g.__webglFramebuffer,y)}else if(N){g.__webglDepthbuffer=[];for(let te=0;te<6;te++)t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[te]),g.__webglDepthbuffer[te]=i.createRenderbuffer(),Ae(g.__webglDepthbuffer[te],y,!1)}else t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer=i.createRenderbuffer(),Ae(g.__webglDepthbuffer,y,!1);t.bindFramebuffer(i.FRAMEBUFFER,null)}function De(y,g,N){const te=n.get(y);g!==void 0&&Ee(te.__webglFramebuffer,y,y.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),N!==void 0&&Xe(y)}function I(y){const g=y.texture,N=n.get(y),te=n.get(g);y.addEventListener("dispose",V),y.isWebGLMultipleRenderTargets!==!0&&(te.__webglTexture===void 0&&(te.__webglTexture=i.createTexture()),te.__version=g.version,o.memory.textures++);const $=y.isWebGLCubeRenderTarget===!0,Q=y.isWebGLMultipleRenderTargets===!0,me=u(y)||a;if($){N.__webglFramebuffer=[];for(let oe=0;oe<6;oe++)if(a&&g.mipmaps&&g.mipmaps.length>0){N.__webglFramebuffer[oe]=[];for(let de=0;de<g.mipmaps.length;de++)N.__webglFramebuffer[oe][de]=i.createFramebuffer()}else N.__webglFramebuffer[oe]=i.createFramebuffer()}else{if(a&&g.mipmaps&&g.mipmaps.length>0){N.__webglFramebuffer=[];for(let oe=0;oe<g.mipmaps.length;oe++)N.__webglFramebuffer[oe]=i.createFramebuffer()}else N.__webglFramebuffer=i.createFramebuffer();if(Q)if(r.drawBuffers){const oe=y.texture;for(let de=0,be=oe.length;de<be;de++){const Ne=n.get(oe[de]);Ne.__webglTexture===void 0&&(Ne.__webglTexture=i.createTexture(),o.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(a&&y.samples>0&&_e(y)===!1){const oe=Q?g:[g];N.__webglMultisampledFramebuffer=i.createFramebuffer(),N.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let de=0;de<oe.length;de++){const be=oe[de];N.__webglColorRenderbuffer[de]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,N.__webglColorRenderbuffer[de]);const Ne=s.convert(be.format,be.colorSpace),q=s.convert(be.type),Ke=R(be.internalFormat,Ne,q,be.colorSpace,y.isXRRenderTarget===!0),He=Re(y);i.renderbufferStorageMultisample(i.RENDERBUFFER,He,Ke,y.width,y.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.RENDERBUFFER,N.__webglColorRenderbuffer[de])}i.bindRenderbuffer(i.RENDERBUFFER,null),y.depthBuffer&&(N.__webglDepthRenderbuffer=i.createRenderbuffer(),Ae(N.__webglDepthRenderbuffer,y,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if($){t.bindTexture(i.TEXTURE_CUBE_MAP,te.__webglTexture),we(i.TEXTURE_CUBE_MAP,g,me);for(let oe=0;oe<6;oe++)if(a&&g.mipmaps&&g.mipmaps.length>0)for(let de=0;de<g.mipmaps.length;de++)Ee(N.__webglFramebuffer[oe][de],y,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,de);else Ee(N.__webglFramebuffer[oe],y,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0);A(g,me)&&x(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Q){const oe=y.texture;for(let de=0,be=oe.length;de<be;de++){const Ne=oe[de],q=n.get(Ne);t.bindTexture(i.TEXTURE_2D,q.__webglTexture),we(i.TEXTURE_2D,Ne,me),Ee(N.__webglFramebuffer,y,Ne,i.COLOR_ATTACHMENT0+de,i.TEXTURE_2D,0),A(Ne,me)&&x(i.TEXTURE_2D)}t.unbindTexture()}else{let oe=i.TEXTURE_2D;if((y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(a?oe=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(oe,te.__webglTexture),we(oe,g,me),a&&g.mipmaps&&g.mipmaps.length>0)for(let de=0;de<g.mipmaps.length;de++)Ee(N.__webglFramebuffer[de],y,g,i.COLOR_ATTACHMENT0,oe,de);else Ee(N.__webglFramebuffer,y,g,i.COLOR_ATTACHMENT0,oe,0);A(g,me)&&x(oe),t.unbindTexture()}y.depthBuffer&&Xe(y)}function ht(y){const g=u(y)||a,N=y.isWebGLMultipleRenderTargets===!0?y.texture:[y.texture];for(let te=0,$=N.length;te<$;te++){const Q=N[te];if(A(Q,g)){const me=y.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,oe=n.get(Q).__webglTexture;t.bindTexture(me,oe),x(me),t.unbindTexture()}}}function Se(y){if(a&&y.samples>0&&_e(y)===!1){const g=y.isWebGLMultipleRenderTargets?y.texture:[y.texture],N=y.width,te=y.height;let $=i.COLOR_BUFFER_BIT;const Q=[],me=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=n.get(y),de=y.isWebGLMultipleRenderTargets===!0;if(de)for(let be=0;be<g.length;be++)t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,oe.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglFramebuffer);for(let be=0;be<g.length;be++){Q.push(i.COLOR_ATTACHMENT0+be),y.depthBuffer&&Q.push(me);const Ne=oe.__ignoreDepthValues!==void 0?oe.__ignoreDepthValues:!1;if(Ne===!1&&(y.depthBuffer&&($|=i.DEPTH_BUFFER_BIT),y.stencilBuffer&&($|=i.STENCIL_BUFFER_BIT)),de&&i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,oe.__webglColorRenderbuffer[be]),Ne===!0&&(i.invalidateFramebuffer(i.READ_FRAMEBUFFER,[me]),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[me])),de){const q=n.get(g[be]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,q,0)}i.blitFramebuffer(0,0,N,te,0,0,N,te,$,i.NEAREST),c&&i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Q)}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),de)for(let be=0;be<g.length;be++){t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.RENDERBUFFER,oe.__webglColorRenderbuffer[be]);const Ne=n.get(g[be]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.TEXTURE_2D,Ne,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglMultisampledFramebuffer)}}function Re(y){return Math.min(r.maxSamples,y.samples)}function _e(y){const g=n.get(y);return a&&y.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function et(y){const g=o.render.frame;h.get(y)!==g&&(h.set(y,g),y.update())}function Ie(y,g){const N=y.colorSpace,te=y.format,$=y.type;return y.isCompressedTexture===!0||y.isVideoTexture===!0||y.format===Ys||N!==Bt&&N!==Wt&&(Ze.getTransfer(N)===tt?a===!1?e.has("EXT_sRGB")===!0&&te===Kt?(y.format=Ys,y.minFilter=Rt,y.generateMipmaps=!1):g=El.sRGBToLinear(g):(te!==Kt||$!==Ln)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",N)),g}this.allocateTextureUnit=P,this.resetTextureUnits=ne,this.setTexture2D=z,this.setTexture2DArray=Y,this.setTexture3D=W,this.setTextureCube=k,this.rebindTextures=De,this.setupRenderTarget=I,this.updateRenderTargetMipmap=ht,this.updateMultisampleRenderTarget=Se,this.setupDepthRenderbuffer=Xe,this.setupFrameBufferTexture=Ee,this.useMultisampledRTT=_e}function Mm(i,e,t){const n=t.isWebGL2;function r(s,o=Wt){let a;const l=Ze.getTransfer(o);if(s===Ln)return i.UNSIGNED_BYTE;if(s===fl)return i.UNSIGNED_SHORT_4_4_4_4;if(s===pl)return i.UNSIGNED_SHORT_5_5_5_1;if(s===Gc)return i.BYTE;if(s===kc)return i.SHORT;if(s===na)return i.UNSIGNED_SHORT;if(s===dl)return i.INT;if(s===wn)return i.UNSIGNED_INT;if(s===fn)return i.FLOAT;if(s===Ji)return n?i.HALF_FLOAT:(a=e.get("OES_texture_half_float"),a!==null?a.HALF_FLOAT_OES:null);if(s===Vc)return i.ALPHA;if(s===Kt)return i.RGBA;if(s===Wc)return i.LUMINANCE;if(s===Xc)return i.LUMINANCE_ALPHA;if(s===$n)return i.DEPTH_COMPONENT;if(s===Ri)return i.DEPTH_STENCIL;if(s===Ys)return a=e.get("EXT_sRGB"),a!==null?a.SRGB_ALPHA_EXT:null;if(s===Yc)return i.RED;if(s===ml)return i.RED_INTEGER;if(s===$c)return i.RG;if(s===gl)return i.RG_INTEGER;if(s===_l)return i.RGBA_INTEGER;if(s===ls||s===cs||s===hs||s===us)if(l===tt)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(s===ls)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===cs)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===hs)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===us)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(s===ls)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===cs)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===hs)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===us)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===Ca||s===La||s===Pa||s===Da)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(s===Ca)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===La)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===Pa)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===Da)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===vl)return a=e.get("WEBGL_compressed_texture_etc1"),a!==null?a.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===Ua||s===Ia)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(s===Ua)return l===tt?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(s===Ia)return l===tt?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===Na||s===Fa||s===Oa||s===Ba||s===za||s===Ha||s===Ga||s===ka||s===Va||s===Wa||s===Xa||s===Ya||s===$a||s===qa)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(s===Na)return l===tt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===Fa)return l===tt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===Oa)return l===tt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===Ba)return l===tt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===za)return l===tt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===Ha)return l===tt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===Ga)return l===tt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===ka)return l===tt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===Va)return l===tt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===Wa)return l===tt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===Xa)return l===tt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Ya)return l===tt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===$a)return l===tt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===qa)return l===tt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===ds||s===ja||s===Ka)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(s===ds)return l===tt?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===ja)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===Ka)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===qc||s===Za||s===Ja||s===Qa)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(s===ds)return a.COMPRESSED_RED_RGTC1_EXT;if(s===Za)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===Ja)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Qa)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===Yn?n?i.UNSIGNED_INT_24_8:(a=e.get("WEBGL_depth_texture"),a!==null?a.UNSIGNED_INT_24_8_WEBGL:null):i[s]!==void 0?i[s]:null}return{convert:r}}class Sm extends Vt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Wi extends xt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const ym={type:"move"};class Ns{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Wi,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Wi,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new L,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new L),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Wi,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new L,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new L),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const S of e.hand.values()){const u=t.getJointPose(S,n),d=this._getHandJoint(c,S);u!==null&&(d.matrix.fromArray(u.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,d.jointRadius=u.radius),d.visible=u!==null}const h=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],p=h.position.distanceTo(f.position),m=.02,_=.005;c.inputState.pinching&&p>m+_?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&p<=m-_&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,n),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=t.getPose(e.targetRaySpace,n),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(ym)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Wi;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const Em=`
void main() {
